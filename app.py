import os, io, threading, re, textwrap, sqlite3
...
def process():
    ...
    threading.Thread(target=process_audio, args=(path, meta)).start()
...
def download():
    ...
    c.drawString(x, y, "Generated using NLP-based Automated Meeting Minutes Generator")
